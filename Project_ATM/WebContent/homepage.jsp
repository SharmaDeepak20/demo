			...
			<div class="container">		
				<nav class="navbar navbar-default">
					<div class="navbar-header">
						...
						<h1><a  href="index.html">Deepak Sharma</a></h1> <!-- Enter name of user -->
					</div>
					<!--navbar-header-->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a href="index.html" class="active">Deposit</a></li>
							<li><a href="#about" class="scroll">Withdrawal</a></li>
							<li><a href="#services" class="scroll">Cheque Book Request</a></li>
							<li><a href="#blog" class="scroll">Transactions</a></li>
							<li><a href="#news" class="scroll">Change PhoneNumber</a></li>
							<li><a href="password.jsp" class="scroll">Reset Pin</a></li>
						</ul>	
